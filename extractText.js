...
I have a block of website content that contains information about a company.
 Could you please analyze it and extract the following fields:
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      let config = {
        ...
        url: "https://miragpt-ks-uat.azurewebsites.net/core/api/v1/chat/completions", // API endpoint
        headers: {
          "access-key": "TuYQ$%1b4cBkuyF8u!MN9DHHhpjq", // Access key for authentication
          model:  "gpt-35-turbo", // Model to be used
